...
class CornerIconOffDemoController : public ImGuiX::Controllers::ExtendedController {
public:
    ...
    void drawUi() override {
        ImGui::Begin("Corner Icon Mode OFF");
        ImGui::TextUnformatted("WindowFlags::HasCornerIconArea is disabled.");
        ImGui::TextUnformatted("This sample is for menu-bar behavior comparison.");
        ImGui::Separator();
...
class CornerIconOffDemoWindow : public ImGuiX::Windows::ImGuiFramedWindow {
public:
    using WindowFlags = ImGuiX::Windows::WindowFlags;

    CornerIconOffDemoWindow(int id, ImGuiX::ApplicationContext& app, std::string name, std::string title)
        : ImGuiFramedWindow(
              id,
              app,
              std::move(name),
    ...
    void onInit() override {
        createController<CornerIconOffDemoController>();
        create(980, 680);
    ...
    void drawTitleBarText() override {
        ...
        ImGui::TextUnformatted("HasCornerIconArea OFF Demo");
    }
...
int main() {
    ...
    app.createWindow<CornerIconOffDemoWindow>("CornerIconOffDemo", "Corner Icon Area OFF Demo");
    app.run();
    return 0;
}
...
#else
int main() {
    static_assert(false, "corner_icon_area_off_demo.cpp requires IMGUIX_USE_SFML_BACKEND defined.");
    return 0;
}
#endif
